...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        JLabel lblsourse = new JLabel("Source");
        lblsourse.setBounds(60, 330, 150, 25);
        lblsourse.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblsourse);
        ...
        // Force revalidation and repaint to ensure proper rendering
        revalidate();
        repaint();
    }
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "Please Wnter Valid Aadhar");
